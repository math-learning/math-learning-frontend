        ...
        return (
            <Card className={styles.card}>
                <div className={styles.displayLine}>
                    <div className={styles.fullWidth}>
                        <Grid container>
                            <Grid item xs={12} md={3}>
                                <Typography className={styles.tcGray1}>Nombre: {exercise.name}</Typography>
                                <Typography className={styles.tcGray1}>Dificultad: {exercise.difficulty}</Typography>
                                <Typography className={styles.tcGray1}>Tipo: {exercise.type}</Typography>
                            </Grid>
                    ...
                    {/* TODO: on click */}
                    <IconButton
                        aria-controls="simple-menu" aria-haspopup="true" onClick={this.showMenu}
                        className={styles.editButton} edge="end">
